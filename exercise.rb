...
v = []
# puts venues[2].values_at(:wheelchair_accessible)[0]
# puts venues[2].values_at(:city)[0]

venues.each do |a|
  if a.values_at(:wheelchair_accessible)[0]==true &&
    a.values_at(:city)[0]=="Toronto" && a.values_at(:capacity)[0]>150
    v << a
  end
end
puts v
